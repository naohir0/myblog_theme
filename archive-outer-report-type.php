...
<main class="ly_top">
  <div class="ly_ArticleLists__outside">
    <h1 class="el_articleListTitle"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/icon-tag@2x.png" height="30"> 海外旅行 記事一覧 (<?php echo wp_count_posts('outer-report-type')->publish;?>)</h1>
